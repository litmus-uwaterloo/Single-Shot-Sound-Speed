% Single Transmit Global Speed-of-Sound Estimation Example Script
% ver. 1.0  (Mar 2025 -- by Pat De la Torre, Di Xiao & Alfred Yu)
%
% Single_Transmit_SoS_Estimation_Example.m
% 
% Usage: 
% This example computes the  speed-of-sound estimation for a set of 15 phantoms. 
...
c0=1540; % Speed of Sound assumed by the US system/Transducer during transmission
rxdelay=4.1e-6; % Sampling delay after transmission
...
for phantom_idx=1:1:total_phantoms
    ...
    for sos_idx=1:length(SoS_coarse)
        ...
        [sample_tensor]=SimplePseudoBeamformer(rf_data , pos_z , pos_x , pos_array_x , SoS_coarse(sos_idx) , tx_angle, c0, fnum, fs ,rxdelay);
